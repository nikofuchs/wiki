...
export default defineConfig({
  ...
  head: [
    ...
    ['script', { defer: '', src: 'https://umami.senko.digital/script.js', 'data-website-id': 'bfea03e3-f799-4fcb-95e9-6ed2e74d757a' }],
  ...
  locales: {
    root: {
      label: 'English',
      lang: 'en',
      description: 'Official wiki of Senko Digital hosting provider - useful guides for managing game servers, using our control panels, setting up VPNs and much more!',
      themeConfig: {
        search: {
          provider: "local",
          options: {
          ...
          '/': [
            ...
            { text: "🤔 How to Choose a Hosting Provider", link: "/how-to-choose-a-provider" },
            {
              ...
              items: [
                ...
                { text: "🔒 Two-Factor Authentication", link: "/personal-area/two-factor-authentication" },
              ],
              collapsed: false,
            },
            {
            ...
            },
            {
              ...
              items: [
                ...
                { text: "🌐 How to install MikroTik CHR", link: "/vps/how-to-install-mikrotik-chr-on-a-virtual-server" },
              ],
              collapsed: false,
            },
            {
    ...
    ru: {
      ...
      lang: 'ru',
      link: '/ru/',
      description: 'Официальная вики хостинг-провайдера Senko Digital - полезные руководства по управлению игровыми серверами, использованию наших панелей управления, настройке VPN и многое другое!',
      themeConfig: {
        search: {
          provider: "local",
          options: {
          ...
          '/ru/': [
            ...
            { text: "🤔 Как выбрать хостинг-провайдера", link: "/ru/how-to-choose-a-provider" },
            {
              ...
              items: [
                ...
                { text: "🔒 Двухфакторная аутентификация", link: "/ru/personal-area/two-factor-authentication" },
              ],
              collapsed: false,
            },
            {
            ...
            },
            {
              ...
              items: [
                ...
                { text: "💾 Как создать резервную копию ВМ", link: "/ru/vps/how-to-create-a-backup" },
                { text: "🔒 Настройка Let's Encrypt", link: "/ru/vps/letsencrypt-ssl" },
                { text: "🚀 Деплой Node.js с PM2", link: "/ru/vps/nodejs-pm2-deploy" },
                { text: "🌐 Установка MikroTik CHR", link: "/ru/vps/how-to-install-mikrotik-chr-on-a-virtual-server" },
              ],
              collapsed: false,
            },
            {
              ...
              items: [
                ...
                { text: "❓ Неверная локация в сервисах Google", link: "/ru/troubleshooting/wrong-geolocation-in-google" },
              ],
              collapsed: false,
            },
            {
