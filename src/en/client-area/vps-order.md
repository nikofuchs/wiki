---
title: "How to order a Virtual Private Server (VPS)"
description: "Quick guide for ordering a Virtual server (VPS) at Senko Digital."
head:
  - - meta
    - name: keywords
  ...
  - - meta
    - property: og:title 
      content: "How to order a Virtual Server (VPS)"
  - - meta
    - property: og:description
      content: "Quick guide for ordering a Virtual server (VPS) at Senko Digital."
---

# How to order a Virtual Private Server (VPS)

Quick guide for ordering a Virtual Private Server (VPS) at Senko Digital.
...
![VPS Plan Selection](/images/client-area/ordering/1.png){data-zoomable}

### Step 2: Authorization

After selecting a plan, you'll be prompted to log in to an existing account or register a new one.

![Authorization page](/images/client-area/ordering/2.png){data-zoomable}

- **If you already have an account**: Log in using your email and password
- **If you don't have an account**: Complete the [quick registration](/client-area/register)
...
![Server order form](/images/client-area/ordering/3.png){data-zoomable}

### Step 4: Payment

Choose a convenient payment method, make the payment, and complete your order.

![Payment method selection](/images/client-area/ordering/4.png){data-zoomable}
...
![VPS credentials email](/images/client-area/ordering/5-en.png){data-zoomable}
