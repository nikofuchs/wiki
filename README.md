...
- **Code**: All rights reserved. The code in this repository is **proprietary** and may not be reused without explicit permission. See [`LICENSE`](https://github.com/senko-digital/wiki/blob/master/LICENSE) for details.
...
This wiki would be not possible without our team and the thoughtful feedback of our lovely customers.
